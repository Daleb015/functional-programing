...
public class FluentDemo {
  ...
  public static void main(String[] args) {
    ...
    // Fluent Version
    new OrderFluent().add("shoes").add("headphones").deliverAt("Cll siempre viva 123").place();

    // Fluent version functional
    OrderFluentFunctional.place(orderFluentFunctional ->
      orderFluentFunctional.add("Shoes").add("Headphones").deliverAt("Cll 123 av siempre viva")
    );
  }
}
