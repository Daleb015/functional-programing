...
public class ParallelStreams {
    public static void main(String[] args) {
        ...
        System.out.println("Performing sequentially :"+list.stream().filter(e -> e.getSalary() > 100).count());
        finishTime = System.currentTimeMillis();

        System.out.println("Time taken sequentially :"+(finishTime-starTime));

        starTime = System.currentTimeMillis();
        System.out.println("Performing parallelism :"+list.parallelStream().filter(e -> e.getSalary() > 100).count());
        finishTime = System.currentTimeMillis();
